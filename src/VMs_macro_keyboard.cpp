...
TKey key[NUMBER_OF_KEYS] = {
  {.pin =  6, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = { {.durationMs = 50, .key = {KEY_6}}}},
  {.pin =  7, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = { {.durationMs = 50, .key = {KEY_7}}}},
  {.pin =  8, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = { {.durationMs = 50, .key = {KEY_8}}}},
  {.pin =  9, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = { {.durationMs = 50, .key = {KEY_9}}}},
  {.pin = 10, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = { {.durationMs = 50, .key = {KEY_F20}}}},
  {.pin = 14, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {}, .action = { {.durationMs = 50, .key = {KEY_MUTE}}}},
  {.pin = 15, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {KEY_LEFT_SHIFT, KEY_LEFT_ALT}, .action = { {.durationMs = 50, .key = {KEY_D}}}},
  {.pin = 16, .type = KEYBOARD, .state = INACTIVE, .stateStartMs = 0, .modificatorKeys = {KEY_LEFT_SHIFT, KEY_LEFT_ALT}, .action = { {.durationMs = 50, .key = {KEY_G}}}},
